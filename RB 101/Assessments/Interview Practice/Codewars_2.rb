...
-compares the value of each member in one array to the corresponding member in
the other
...
PROBLEM given two arrays of equal length do some math with corresponding values
