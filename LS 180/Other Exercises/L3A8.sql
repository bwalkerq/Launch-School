...
values (default, 'William',	'Swift', 7204890809);
insert into calls (id, "when", duration, contact_id)
values (default, '2016-01-18 14:47:00', 632, 6 );

select "when", duration, c.first_name from calls
join contacts c on calls.contact_id = c.id
-- where first_name <> 'William'
WHERE (c.first_name || ' ' || c.last_name) != 'William Swift';
--their solution did this string concat thing!
...
insert into calls (id, "when", duration, contact_id)
values
    (default, '2016-01-17 11:52:00', 175, 27),
    (default, '2016-01-18 21:22:00', 79, 28);

alter table contacts add unique(number);

insert into contacts (first_name, last_name, number)
values ('a', 'b', 7204890809);
